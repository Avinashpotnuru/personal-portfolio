...
const Skills = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full mx-auto my-5">
      <motion.h1
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="flex flex-col border-2 border-gray-500 rounded-md lg:py-10  w-[95%] mx-auto sm:w-[90%] overflow-hidden ">
        <motion.h1
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.5, delay: 0.7 }}
